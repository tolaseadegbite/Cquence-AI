...
export default class extends Controller {
  ...
  // === ADD THIS NEW ACTION ===
  // This action allows other controllers to switch tabs programmatically.
  // It expects a parameter named 'index'.
  selectByIndex(event) {
    // event.params.index will contain the value from data-tabs-index-param
